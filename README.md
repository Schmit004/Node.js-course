...
Когда событие происходит, Event Demultiplexer распределяет его к соответствующему обработчику событий (event handler). Схема работы демультиплексора изображена на ![схеме](./assets/Demultiplexer.png)
...
Подробнее о каждом модуле смотреть информацию в директории _module-info_ текущего проекта.
